...
const getIconByType = (type: string) => {
    switch (type) {
        case 'Workspace':
            return <Workspace className='h-5 w-5 text-primary-yellow shadow-custom overflow-hidden bg-transparent' />;
        case 'Platinum':
            return <Platinum className='h-5 w-5 text-primary-yellow shadow-custom overflow-hidden bg-transparent' />;
        case 'Campus':
            return <Campus className='h-5 w-5 text-primary-yellow shadow-custom overflow-hidden bg-transparent' />;
        case 'Honeykomb':
            return <Honeykomb className='h-5 w-5 text-primary-yellow shadow-custom overflow-hidden bg-transparent' />;
        default:
            return null;
    }
};
...
const SpaceOverviewCard = ({
    ...
    return (
        <div
            ...
            onClick={() => { }}
        >
            <div className={clsx('relative flex gap-4 rounded-lg bg-white p-3 shadow-4 transition-all duration-300 flex-col',)}>
                        ...
                        <div className='flex  justify-between  bg-main-light-grey p-4 rounded-md'>
                            <div className='flex flex-col gap-1'>
                                ...
                                <div className='flex justify-center'>
                                    ...
                                    <Text
                                        value={'/Day'}
                                        className='text-xxs text-gray4 mt-2.5'
                                    />
                                </div>
                            </div>
